...
export class ChatroomController{
    ...
    async createChatroom(req: Request, res: Response) {
        try {
            ...
            return ResponseUtils.sendSuccessResponse(res, 200, "Chatroom created successfully", chatroomData)
        } catch (error: any){
            return ResponseUtils.sendErrorResponse(res, 500, "Failed to create chatroom", error)
        }
    }
    ...
    async deleteChatroom(req: Request, res: Response) {
        try {
            ...
            await batch.commit();
            return ResponseUtils.sendSuccessResponse(res, 200, "Chatroom deleted successfully", chatroomDoc.data())
        } catch (error: any){
            return ResponseUtils.sendErrorResponse(res, 500, "Failed to delete chatroom", error)
        }
    }
    ...
    async updateChatroom(req: Request, res: Response) {
        try {
            ...
            return ResponseUtils.sendSuccessResponse(res, 200, "Chatroom updated successfully", chatroomDoc.data())
        } catch (error: any){
            return ResponseUtils.sendErrorResponse(res, 500, "Failed to update chatroom", error)
        }
    }
        ...
        try {
            ...
            const formattedMessages = chatroomData.messages.map((message) => {
                const dateCreated = new Date(
                    message.dateCreated.seconds * 1000 + message.dateCreated.nanoseconds / 1000000
                )
                return { ...message, dateCreated }
            })

            const formattedChatroomData = { ...chatroomData, messages: formattedMessages }
            return ResponseUtils.sendSuccessResponse(res, 200, "Chatroom data retrieved successfully", formattedChatroomData)
        } catch (error: any){
            return ResponseUtils.sendErrorResponse(res, 500, "Failed to retrieve chatroom data", error)
        }
    }
    ...
    async showChatroomDataByUserId(req: Request, res: Response) {
        try {
            ...
            const chatroomData: ChatroomModel[] = chatroomSnapshot.docs.map((doc) => doc.data() as ChatroomModel)
            return ResponseUtils.sendSuccessResponse(res, 200, "Chatroom data retrieved successfully", chatroomData)
        } catch (error: any){
            return ResponseUtils.sendErrorResponse(res, 500, "Failed to retrieve chatroom data", error)
        }
    }
    ...
    async deleteAllChatroom(req: Request, res: Response){
        try {
            ...
            await batch.commit()
            return ResponseUtils.sendSuccessResponse(res, 200, "All chatrooms deleted successfully", null)
        } catch (error: any) {
            return ResponseUtils.sendErrorResponse(res, 500, "Failed to delete all chatrooms", error)
        }
    }
}